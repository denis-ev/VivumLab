...
class Ssh < Thor
  ...
  def create_sshkey
    say I18n.t(:s_ssh_keyexists).red && return if ssh_key_exists?
    say I18n.t(:s_ssh_keycreating).yellow
    # rubocop:disable Layout/LineLength
    ...
    # rubocop:enable Layout/LineLength
    say I18n.t(:s_ssh_keycreated).green
  end

  desc 'copy_sshkey', 'Copy your ssh key over to the server'
  def copy_sshkey
    say I18n.t(:s_ssh_keycopying).yellow
    to_run = <<-EXECUTE
    ...
    say I18n.t(:s_ssh_keycopied).green
  end
