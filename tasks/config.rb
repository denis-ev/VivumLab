...
class Config < Thor
  ...
  def reset
    say I18n.t(:s_config_resetting)
    say I18n.t(:s_config_backup)
  ...
  def edit_raw
    say I18n.t(:s_config_editfile)
    begin
      write_temporary_decrypted_config
      execute_in_shell "nano #{@temp_config}"
    rescue Subprocess::NonZeroExit
      say I18n.t(:s_config_editerror).red
    ensure
      FileUtils.rm_f @temp_config
      say I18n.t(:s_config_fileremove).yellow
    end
  end
  ...
  def decrypt
    ...
    say I18n.t(:s_config_decrypted).green
  end
  ...
  def encrypt
    ...
    say I18n.t(:s_config_encrypted).green
  end
